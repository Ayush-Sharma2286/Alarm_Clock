...
const ShowMsgs=()=>{
    ...
    if(arr1[0]==ph && arr1[1]==a.innerText){
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>Good Morningi! Hey Its Time To Wake Up</h2>"
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>Its time to take a nap</h2>"
